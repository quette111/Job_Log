...
function _postData() {
  _postData = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var username, lastName, email, password;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          _context.prev = 13;
          _context.next = 16;
          return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/api/v1/login', {
            first: username,
            last: lastName,
            email: email,
            password: password
        ...
        case 26:
          ...
          console.error('Error sending frontend data', _context.t0);
        case 29:
        case "end":
